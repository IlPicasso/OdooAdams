...
Ver archivo `VERSION` (actual: `0.6.0`).
...
- Se mantiene también `oec/custom-addons/hello_world` para entornos OEC.SH que aún estén apuntando a esa ruta legacy.
- La ruta preferida sigue siendo `addons/hello_world`.
